...
const PDP_URI = 'products/spotted-panther-bralette?variant=40090505379884'

let newColor = ['grey', 'fallenrock', 'poppyred', 'keepsakelilac', 'laurelgreen', 'provincialblue', 'blueiris', 'blueopal']
let newPrintColor = ['spottedpanther', 'picnicrose']

const pdpType = 'afbralette'

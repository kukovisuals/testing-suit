...
const PDP_URI = 'products/hyper-pink-mesh-highwaisted?variant=40090461732908'

let newColor = ['hyperpink', 'black', 'coralpink', 'limepunch', 'caribbeansea']
let newPrintColor = ['']

        
const pdpType = 'hchighwaisted'

...
const PDP_URI = 'products/black-high-waisted-panties?variant=34835418316844'

let newColor = ['black', 'grey', 'nude', 'fallenrock', 'sunkissed', 'espresso', 'poppyred', 'keepsakelilac', 'laurelgreen', 'limepunch', 'fjordblue', 'blueiris']
let newPrintColor = ['picnicrose', 'spottedpanther', 'sleektiger', 'darkpalm']

        
const pdpType = 'highwaisted'

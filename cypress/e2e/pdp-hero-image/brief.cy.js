...
const PDP_URI = 'products/black-brief-panties?variant=34834826166316'

let newColor = ['black', 'castorgrey', 'grey', 'nude', 'fallenrock', 'sunkissed', 'espresso', 'poppyred', 'strawberryice', 'rosedust', 'laurelgreen', 'limepunch', 'provincialblue', 'blueiris', 'blueopal', 'white']
let newPrintColor = ['spottedpanther', 'sleektiger', 'darkpalm']

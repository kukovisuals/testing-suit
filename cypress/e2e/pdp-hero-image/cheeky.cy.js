...
const PDP_URI = 'products/poppy-red-cheeky-panties?variant=39559056982060'

let newColor = ['poppyred', 'black', 'grey', 'nude', 'fallenrock', 'rosedust', 'laurelgreen', 'blueiris', 'blueopal', 'white']

        
const pdpType = 'cheeky'
...
describe(`Check Colors in ${pdpType}`, () => {
    ...
    for(const color of newColor){
        ...
        it(`[Color] should return 200 -------> PROD---${color}${rest_CDN}`, () => {

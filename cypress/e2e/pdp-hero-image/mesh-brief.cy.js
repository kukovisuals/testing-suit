...
const PDP_URI = 'products/black-mesh-brief-panties?variant=39470502641708'

let newColor = ['black', 'hyperpink', 'coralpink', 'limepunch', 'caribbeansea']
let newPrintColor = ['']

        
const pdpType = 'brief'
const CDN = 'https://cdn.shopify.com/s/files/1/0313/4062/5964/products/PROD---'
const rest_CDN = `--sheer--${pdpType}--missy---prod_lf.jpg`;
